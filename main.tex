...
\begin{center}
    Die gemeinsame Punkte der Ebene mit den Koordinatenebenen heißen \textbf{Spurgeraden}.
\end{center}
\WFclear
\newpage
...
\vspace*{3.5cm}
\WFclear
Um eine Ebenengleichung von anhand der Spurpunkte zu bestimmen, gilt mit allgemeinen Spurpunkten
